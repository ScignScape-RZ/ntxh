...
\section{Group 1: Interacting with the Main Window}
  ...
  draw opacity=0.5,line width=1mm, fill opacity=0.9]
   ...
   (\circled{2}) and sorting columns by switching 
   notebook tabs  (\circled{1}); each notebook page shows the data sorted 
   ...
   spreadsheet-like features are implemented via context menus.}};
      ...
      \annotatedFigureBox{0.93,0.67}{0.93,0.71}{2}{0.93,0.663}%
      \annotatedFigureBox{0.01,0.86}{0.34,0.935}{1}{0.17,0.85}% 

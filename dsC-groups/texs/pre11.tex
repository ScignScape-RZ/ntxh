...
\hspace*{6pt}\OneQuad
{
\begin{quadblock}{Datasets Compiled From Book Examples}
\hspace{1cm}{\parbox{19cm}{\LARGE
\fontseries{b}\selectfont
{
The following screenshots demonstrate how data sets can be 
used even outside of the context of a lab generating 
experimental data.  The pictured data set represents a corpus 
of linguistic examples mined from the \textit{Blackwell Handbook 
...
texts should be annotated so that extracting examples can be automated.
\item[Annotation] Linguistic corpora are often annotated 

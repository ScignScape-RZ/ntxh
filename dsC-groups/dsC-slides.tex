...
\newcommand{\cframedboxxblue}[3]{\begin{mdframed}
		[linecolor=blue!70!black,linewidth=#2]\hspace{#1}#3\end{mdframed}}
...
\newcommand{\thrulexrev}{\vspace{-1.5em}{%
		\color[RGB]{10,47,100}{\hrule  height 8pt}\vspace{-2pt}
		\color[RGB]{14,67,19}{\hrule height 8pt}}\vspace{2.3em}}
...
\newcommand{\xatspt}{%
	\AddToShipoutPicture*{%
		\raisebox{17cm}{\hspace{26.2cm}\parbox{6cm}{%
...
\newcommand{\xatsptt}{%
	\AddToShipoutPicture*{%
		\raisebox{17.5cm}{\hspace{27.2cm}\parbox{6cm}{%
...
%\raisebox{4cm}{\hspace{26cm}\includegraphics[width=8cm]{logo.png}}

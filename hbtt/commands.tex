...
\stepcounter{subs}
%\setcounterref{subsection}{\thesubs}
...
\newcommand{\spsubsectiontwolinerepl}[2]{\stwoline{#1}\subss{#2}{\twoline}}
\newcommand{\subsectiontwolinerepl}[2]{\stwoline{#1}\subss{#2}{\twoline}
...
\usepackage[letterpaper, left=.47in,right=.47in,top=.94in,bottom=.94in]{geometry}

\let\xbibitem\bibitem
\renewcommand{\bibitem}[2]{\vspace{4pt}\xbibitem{#1}{#2}}
...
\newcommand{\thindecoline}{\vspace*{-.15em}\thinsectionline{blGreen!10!orange}\vspace*{-.45em}}
...
\newcommand{\caltypeT}{\ensuremath{\mathcal{T}}}
\newcommand{\calS}{\ensuremath{\mathcal{S}}}

\newcommand{\typeTp}{\ensuremath{\mathcal{T}'}}
\newcommand{\typeTpp}{\ensuremath{\mathcal{T}''}}

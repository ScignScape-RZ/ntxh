...
called and how polymorphism is resolved.\footnote{Also, as I discussed earlier, \q{chaining} method calls means 
...
detail of \q{Channel Bundles} we can additionally say that the
...
describing how a Channel Bundle is concretely provisioned with values
(i.e., a package).
}

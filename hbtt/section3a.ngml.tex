...
\p{Notice that one single literal may initialize carriers of multiple types;
...
That is, for each metaconstructor \mdash{} again, a value constructor
whose result is a value constructor whose result is a value of some type \tTy{}
\mdash{} there must be exactly one code-span notating the value constructor's implementation.
...
other type \mdash{} does not correspond with the nature of concepts: while
...
\nVal{} has to be provided to a \lambdach{} channel, at least

...
(one or more) outputs with their respective types.  In practice, 
...
\p{My strategy for unifying multiple \mOldLambda{}-calculi depends 
...
I (Nathaniel), age 46, live in Brooklyn as a registered Democrat.  This may be
...
fact \q{(A/The person named) Nathaniel, 46, has lived in Brooklyn,

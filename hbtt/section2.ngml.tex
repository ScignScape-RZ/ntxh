...
\cite{JohnStellFCA}, \cite{BalintMolnar}).
...
Ontology design (see \cite{Aranda}, \cite{Fabrikant},
\cite{SegevGal}, \cite{BittnerSmithDonnelly},
\cite{BittnerSmith}, \cite{MaureenDonnelly}, 
\cite{BarrySmithBlood}, \cite{PetitotSmith},
...
\item{} \label{chaining} In the object-oriented technique known as \q{method chaining},
...
In essence: a procedure's signature, or
type-expression, can be seen as a \q{sum
of channels}, or an inter-channel operation.
...
variations on \mOldLambda{}-Calculi and

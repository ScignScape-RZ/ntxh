...
respectively.  The data profile germane to 
...
users' moods.  On the other hand, a voice-based 
...
where speech data is parsed for language 
...
example of raw CyberPhysical input (the audio files), midstream 
...
information as an organizing device, heightening security 
...
programming type systems, which has the effect of 
...
Here, In lieu of \q{data-centric} 
Ontologies, whose mission is to standardize data 
\i{representation}, I will consider \q{Procedural} 
...
data publishing methodology is one concrete 
step which engineers could take toward 
a more robust CyberPhysical software-development ecosystem.  
Accompanying materials for this volume, for instance, 

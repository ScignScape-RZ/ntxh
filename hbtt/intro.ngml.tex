...
Semantic Web technologies (detailed in \hyperref[RDF]{\ref{RDF}}).  
...
Sections \sectsym{}\hyperref[sectTwo]{\ref{sectTwo}} and 
\sectsym{}\hyperref[sectThree]{3}, 
I will pivot later in the chapter to Requirements Engineering 
in the type-theoretic context 
(particularly in \hyperref[RDF]{\ref{Channelized}}).  
...
procedure's types is an important basis for tracing 
how procedures interoperate to ensure specification 
conformance. 
} 
\p{The overall structure of this chapter, then, can be seen 
as to build an exceptionally expressive procedure-oriented 
type system and then, secondarily, present some ideas 
for how such a system can be leveraged toward in CyberPhysical 
Requirements Engineering.  Section \sectsym{}\hyperref[sectOne]{1} 
here is more general and reviews the pertinent issues in practice, 
while Sections \sectsym{}\hyperref[sectTwo]{2} and 
\sectsym{}\hyperref[sectThree]{3} are more abstract and fundamental.  
I then return to some more applied themes within 
Section \sectsym{}\hyperref[sectFour]{4} and after.
}

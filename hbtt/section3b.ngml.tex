...
types or states.
Practically, working with scenarios like range-bounded values \mdash{} which
in principle exemplifies programming tasks where Dependent Types can be a
useful idiom \mdash{} in practice arguably ends up more like typestate
...
\open{}, \nonexistent{}\enumright{}, for example.
}

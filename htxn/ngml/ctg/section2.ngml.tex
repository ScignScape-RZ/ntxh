...
see the \q{parse\Asxp} method in file ntxh-udp-sentence.cpp).}
...
\udref{enAgum-ud-train}{GUMAvoyageAmerida-20}
\end{sentenceList}
...
\udref{enAgum-ud-train}{GUMAvoyageAsocotra-16}
\end{sentenceList}
...
\udref{enAgum-ud-train}{GUMAvoyageAphoenix-30}

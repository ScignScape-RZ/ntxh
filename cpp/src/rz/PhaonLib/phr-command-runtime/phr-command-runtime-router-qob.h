...
#ifndef PHR_COMMAND_RUNTIME_ROUTER_QOB__H
#define PHR_COMMAND_RUNTIME_ROUTER_QOB__H
...
struct Do_Invoke_Method__Cast_Schedule__QOB
{
 ...
 struct Cast_2_Readyx
 {
  ...
  static void run(QString method_name, OBJECT_Type obj, QVector<PHR_Command_Runtime_Argument*>& args,
                  ARG1_Type& arg1, ARG2_Type& arg2,
                  const QVector<PHR_Command_Runtime_Router::Argument_Info>& argument_info)
  {
...
#define CAST_INDEX_SWITCH(TYPE) \
 ...
 struct Cast_2
 {
  ...
  static void run(QString method_name, OBJECT_Type obj,
                  int cast_index, PHR_Command_Runtime_Router& kcrr,
                  QVector<PHR_Command_Runtime_Router::Argument_Info>& argument_info,
                  QVector<PHR_Command_Runtime_Argument*>& args)
  {
   if(cast_index == ready_at_cast_index)
   {
    ...
    case PHR_Command_Runtime_Router::Arg_Type_Codes::No_Return:
     ...
     break;
    case PHR_Command_Runtime_Router::Arg_Type_Codes::Int:
     {
   ...
   else
   {
    ...
    PHR_Command_Runtime_Router::QOB_Argument_Conventions ac =
      argument_info[next_cast_index].qob_convention;
    switch(ac)
    {
    case PHR_Command_Runtime_Router::QOB_Argument_Conventions::QString_Direct:
    case PHR_Command_Runtime_Router::QOB_Argument_Conventions::Value_From_QString:
    case PHR_Command_Runtime_Router::QOB_Argument_Conventions::QObject_Direct:
     {
...
#define CAST_READY_MACRO(ARG_COUNT) \
 ...
 { \
  ...
  static void run(QString method_name, OBJECT_Type obj, QVector<PHR_Command_Runtime_Argument*>& args \
   TYPENAMES_arg,  const QVector<PHR_Command_Runtime_Router::Argument_Info>& argument_info) \
  { \
   QMetaObject::invokeMethod(obj, method_name.toLatin1() \
    QARGUMENTS ); \
  } \
  ...
  static void run(QString method_name, OBJECT_Type obj, QString return_type, \
   RET_Type& ret, QVector<PHR_Command_Runtime_Argument*>& args \
   TYPENAMES_arg,  const QVector<PHR_Command_Runtime_Router::Argument_Info>& argument_info) \
  { \
   QMetaObject::invokeMethod(obj, method_name.toLatin1(), \
    QReturnArgument<RET_Type>(return_type.toLatin1(), ret) \
...
#define CAST_READY_SWITCH_MACRO(ARG_COUNT) \
   ...
   case PHR_Command_Runtime_Router::Arg_Type_Codes::No_Return: \
    ...
    break; \
   case PHR_Command_Runtime_Router::Arg_Type_Codes::Void_Pointer: \
    { \
     ARGS_TEMP_MACROS \
   ...
   case PHR_Command_Runtime_Router::Arg_Type_Codes::Int: \
    ...
    break; \
   case PHR_Command_Runtime_Router::Arg_Type_Codes::QString_Return: \
    { \
...
//    ( tnw.toLatin1(), arg1) );
  ...
  PHR_Fn_Doc* fnd = (PHR_Fn_Doc*) obj;
  PHR_Env* penv = (PHR_Env*)(quint64) arg1;

  fnd->init(penv);

    QMetaObject::invokeMethod(obj, mn.toLatin1() ,QArgument<ARG1_Type>
      ( tnw.toLatin1(), arg1) );
...
{
 int next_cast_index = cast_index + 1;
 PHR_Command_Runtime_Router::QOB_Argument_Conventions ac = argument_info[next_cast_index].qob_convention;
 switch(ac)
 {
 case PHR_Command_Runtime_Router::QOB_Argument_Conventions::QString_Direct:
 case PHR_Command_Runtime_Router::QOB_Argument_Conventions::Value_From_QString:

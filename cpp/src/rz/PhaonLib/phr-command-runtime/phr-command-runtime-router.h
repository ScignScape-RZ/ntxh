...
class PHR_Expression;
class PHR_Proxy_Scope;
...
private:
 ...
 {
  static void run(PHR_Command_Runtime_Router* this_, QVector<PHR_Command_Runtime_Argument*>& args);
  static void run__no_uc(PHR_Command_Runtime_Router* this_, QVector<PHR_Command_Runtime_Argument*>& args);
 };
 ...
 struct Do_Invoke_Method_<Arg_Count, true>
 {
  ...
  {
   static void run(PHR_Command_Runtime_Router* this_,
     QVector<PHR_Command_Runtime_Argument*>& args)
   {
 ...
 void do_invoke_method(QVector<PHR_Command_Runtime_Argument*>& args);

 void init_argument_info(QVector<PHR_Command_Runtime_Argument*>& args,
   QVector<quint64>& store);
 void init_argument_info_qob(QVector<PHR_Command_Runtime_Argument*>& args,
   QVector<quint64>& store);
 void init_argument_info_uc(QVector<PHR_Command_Runtime_Argument*>& args,
   QVector<quint64>& store);



 PHR_Command_Runtime_Argument* sigma_argument_;
 QVector<PHR_Command_Runtime_Argument*> lambda_arguments_;
...
public:
 ...
 PHR_Channel_Group* get_channel_group();

 void parse_command_package(PHR_Command_Package* cpkg);
 PHR_Command_Runtime_Argument* parse_carrier_to_argument(PHR_Carrier& kcc, int pos);

 void proceed();
 void proceed_s0(PHR_Function_Vector* pfv);
 void proceed_s1(PHR_Function_Vector* pfv);

 void proceed_s0_argvec(s0_fn1_p_type fn, void** pResult, int byte_code,
   bool sr, int s10_size = 0);

 void proceed_s0_0(PHR_Function_Vector* pfv, void** pResult);

 void proceed_s0_1(PHR_Function_Vector* pfv, void** pResult);

 void proceed_s0_2(PHR_Function_Vector* pfv, void** pResult);
 ...
 void proceed_s1_2(PHR_Function_Vector* pfv, void** pResult, void* raw_value);

 void proceed_s1_0_uc(PHR_Function_Vector* pfv, void** pResult, void* raw_value);

...
QString PHR_Command_Runtime_Argument::type_name_to_qt_type_name(QString tn)
{
...
QString PHR_Command_Runtime_Argument::qob_reflection_type_name()
{
...
QString PHR_Command_Runtime_Argument::qob_reflection_modifier()
{
 return QString();
}

...
void PHRA_Binary_Channel::append(u8 u)
{
 int sz = values_.size();
 values_.append(8, 0);
 values_[sz] =      u & 0x00000000000000ff; 
 values_[sz + 1] = (u & 0x000000000000ff00) >> 8; 
 values_[sz + 2] = (u & 0x0000000000ff0000) >> 16; 
 values_[sz + 3] = (u & 0x00000000ff000000) >> 24; 
 values_[sz + 4] = (u & 0x000000ff00000000) >> 32; 
 values_[sz + 5] = (u & 0x0000ff0000000000) >> 40; 
 values_[sz + 6] = (u & 0x00ff000000000000) >> 48; 
 values_[sz + 7] = (u & 0xff00000000000000) >> 56; 
}

...
// wg_dump(white_db_, "/home/nlevisrael/mb/whitedb/QWhite/databases/test/t-100.wdb");
...
template<>
wg_int QWhite_Database::translate_data(wg_int data)
{
 return data;
}
template<>
...
wg_int QWhite_Database::_add_column_entry_(QWhite_Column* qc, wg_int data,
...
wg_int QWhite_Database::_add_column_entry(QWhite_Column* qc, wg_int data,
  quint32& column_specific_record_index, quint32& field_number)
{
...
template<>
void QWhite_Database::untranslate_data(wg_int data, wg_int& dt)
{
 dt = data;
}
template<>

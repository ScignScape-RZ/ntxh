...
studied via mathematical frameworks such as the Lambda Calculus, 
...
via directed graphs (\cite{MadalinaCroitoru}, \cite{AnglesGuttierez},
and \cite{ErnestoDamiani} are good discussions of

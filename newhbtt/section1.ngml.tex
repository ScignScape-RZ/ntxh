...
\cite{PhilipEBourne}, \cite{MarkDWilkinson}). 
}
\p{Alongside these demo sets, an addition demonstrative 
example is provided addressing biomedical device profiles 
and patient data (including privacy and security concerns).  
The focus of these examples is more architectural: 
...
proper protocols for accessing those layers.  The demo 
...
\p{Software-centric modeling such as prototyped in 
these demo implementations is not always a priority 
of data set publishers \mdash{} which suggests that new 

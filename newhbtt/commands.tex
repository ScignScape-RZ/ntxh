...
\usepackage[letterpaper, left=.47in,right=.47in,top=.7in,bottom=.7in]{geometry}
...
\newcommand{\gOpTransferOneOneF}{\codeText{g:}\codeTextch{return$_1$}{\codeTextr{\opTransfer}}%
\codeText{f:}\codeTextch{lambda$_1$}}
...
\definecolor{bblGreen}{rgb}{.2,.5,.5}

\colorlet{chc}{bblGreen!30!black}

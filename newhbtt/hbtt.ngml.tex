...
\include{commands}
\begin{document}\title{Hypergraph Type Theory and Requirements Engineering 
...
of \q{channels} which permits an integration between 
graph-based code models with type thories 

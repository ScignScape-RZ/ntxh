...
\p{The chapter by Teixera \i{et. al.}, which I cited earlier,  
considers voice-activated 
CyberPhysical interfaces; in this context Natural Language 
...
\p{I have also isolated the important components where these 
diverse requirements may be exercised \mdash{} specifically, 
hub \i{libraries} that are intermediaries between CyberPhysical 
devices and hub applications.  Hub libraries therefore need 

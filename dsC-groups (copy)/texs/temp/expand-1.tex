...
\begin{document}
  ...
  \node [text width=7.23cm,align=justify,fill=logoCyan!20, draw=logoBlue, 
  ...
  draw opacity=0.5,line width=1mm, fill opacity=0.9]
   at (0.18,0.49){\textbf{In addition, nested rows can 
   display supplemental infomation, such as data values' 
   rank (\circled{2}) and percentage (\circled{3}) 

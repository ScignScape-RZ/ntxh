...
\newcommand{\sft}[1]{\vspace*{.25cm}\raisebox{-.35cm}{%
\contour{MSUgreen!50!yellow}{{\protect\LARGE{\protect\textbf{#1}}}}}}

\newcommand{\lft}[1]{\vspace*{.25cm}\raisebox{-.35cm}{%
\contour{MSUgreen!50!yellow}{{\protect\LARGE{\protect\textbf{#1}}}}}}
...
\newcommand\TwoQuad[2]{%
	\begin{minipage}[b][.45\textheight][t]{1.01\textwidth}#1\end{minipage}
	\begin{minipage}[b][.45\textheight][t]{1.01\textwidth}#2\end{minipage}%
}
...
%\setbeamersize{description width=4cm}

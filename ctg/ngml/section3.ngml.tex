...
of truth-theoretic paradigms in \i{The Embodied Mind}.  
...
overlap:
\begin{sentenceList}\sentenceItem{} \swl{itm:almond}{Do you have almond milk?}
\sentenceItem{} \swl{}{Can you get MsNBC on your TV?}
\sentenceItem{} \swl{itm:needcorkscrew}{This isn't a screw-cap bottle: I need a corkscrew.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I think the window is open, can you close it?}
\sentenceItem{} \swl{}{I see you have almond milk, can I have some?}
\sentenceItem{} \swl{}{If you get MsNBC, can you turn on Rachel Maddow?}
\sentenceItem{} \swl{}{If there is a corkscrew in the house, can you get it?}
\end{sentenceList}
}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I believe you have a reservation for Jones?}
\sentenceItem{} \swl{}{I believe this is the customer service desk?}
\sentenceItem{} \swl{}{I believe we ordered a second basket of garlic bread?}
...
\begin{sentenceList}\sentenceItem{} \swl{}{Do you have any milk?}
\sentenceItem{} \swl{}{Yes, we have almond milk.}
\sentenceItem{} \swl{}{No, we have almond milk.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:put}{Can you put some almond milk in my coffee?}
\sentenceItem{} \swl{itm:after}{Is there milk in this coffee?}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{It's not open, but there's still some
cold air coming through the cracks.}
\sentenceItem{} \swl{}{It's not open, but I closed the window in
the bedroom.}
\sentenceItem{} \swl{}{I can't \mdash{} it's stuck.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I believe the kitchen window
...
like
\begin{sentenceList}\sentenceItem{} \swl{}{Grandma wants us to close the window.}
\sentenceItem{} \swl{}{He wants a bottle opener.}
\end{sentenceList}
But to respond politely we need to modify
the parse of their requests to capture the
\q{essential} content:
\begin{sentenceList}\sentenceItem{} \swl{}{Grandma wants us to eliminate the cold draft.}
\sentenceItem{} \swl{}{He wants something to open that bottle.}
\end{sentenceList}
...
that is open:
\begin{sentenceList}\sentenceItem{} \swl{itm:can}{Can I have some milk?}
\sentenceItem{} \swl{itm:close}{Can you close the kitchen window?}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:store}{Remember that wine we tasted on the Niagara 
...
\begin{sentenceList}\sentenceItem{} \swl{}{That wine was a Cabernet Franc.}
...
\begin{sentenceList}\sentenceItem{} \swl{}{Those dogs are Staffordshires.}
\sentenceItem{} \swl{}{What's a Staffordshire?}
\sentenceItem{} \swl{}{It's a breed of dog.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{If the kitchen window is closed,
...
by cases like
\begin{sentenceList}\sentenceItem{} \swl{}{This wine is a young Syrah.}
\sentenceItem{} \swl{}{My cousin adopted one of my neighbor's dog's puppies.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:maj}{The majority of students polled were
...
\sentenceItem{} \swl{itm:many}{Many students have protested the tuition increases.}
\end{sentenceList}
}
...
the discourse, like:
\begin{sentenceList}\sentenceItem{} \swl{}{Most students oppose the tuition increase.}
\sentenceItem{} \swl{itm:indef}{Most students oppose a tuition increase.}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:today}{Today the state university system
...
\begin{sentenceList}\sentenceItem{} \swl{itm:sas}{Student after student came out against the tuition hikes.}
...
\subsection{Cognitive-Transform Interpretation}
...
leave out).  In the (\ref{actually}) case, the modifier 
...
of (\ref{actually}) is not just to point out that 
...
\p{For other examples, in (\ref{itm:amibence}) the \i{colonial ambience} and 
\i{tropical climate} disjunction partly shifts the sense of 
\i{the city} from its stutus as something constructed and 
...
\mdash{} if the phrase were \i{its climate} we would resolve \i{it} backwark 
...
\begin{sentenceList}\sentenceItem{} \swl{itm:pipe}{We understand that the pipe fitters are also planning to picket the Lake Worth, Florida project as well.}
...
copora parse-graph, which just sees \i{also} as a common auxiliary.  
In general, the extra \q{layers} of meaning I have identified for 
(\ref{itm:actually}), (\ref{itm:amibence}), and (\ref{itm:pipe}) 

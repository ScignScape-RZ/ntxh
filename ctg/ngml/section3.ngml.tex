...
overlap:
\begin{sentenceList}\sentenceItem{} \swl{itm:almond}{Do you have almond milk?}{pra}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I think the window is open, can you close it?}{pra}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I believe you have a reservation for Jones?}{pra}
...
acessories in this section?}{pra}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{Do you have any milk?}{pra}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:put}{Can you put some almond milk in my coffee?}{pra}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:TheWindow}{The window, it's still open.}{pra}
...
page 132, chapter 6):
\begin{sentenceList}\sentenceItem{} \swl{itm:scribbled}{He scribbled on a living-room wall.}{sem}
%\udref{HandbookCh.}{}
\end{sentenceList}
...
we can use \i{close \i{textul.the} window} even if we are referentially 
ambiguous about which window is open \mdash{} both (\ref{itm:AWindow}) 
and (\ref{itm:TheWindow}) are almost interchangable.  The reason 
...
the perceptual multiplicity of four walls, but a matter 
...
protects people inside the room (as part of a building's 
stuctural integrity), and so forth.  We can say \i{the} wall 
...
like
\begin{sentenceList}\sentenceItem{} \swl{}{Grandma wants us to close the window.}{pra}
...
\q{essential} content:
\begin{sentenceList}\sentenceItem{} \swl{}{Grandma wants us to eliminate the cold draft.}{pra}
...
that is open:
\begin{sentenceList}\sentenceItem{} \swl{itm:can}{Can I have some milk?}{pra}
...
\begin{sentenceList}\sentenceItem{} \swl{}{That wine was a Cabernet Franc.}{ref}
...
\begin{sentenceList}\sentenceItem{} \swl{}{Those dogs are Staffordshires.}{pra}
...
by cases like
\begin{sentenceList}\sentenceItem{} \swl{}{This wine is a young Syrah.}{log}
...
the discourse, like:
\begin{sentenceList}\sentenceItem{} \swl{}{Most students oppose the tuition increase.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:sas}{Student after student came out against the tuition hikes.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:pipe}{We understand that the pipe fitters are also planning to picket the Lake Worth, Florida project as well.}{sco}

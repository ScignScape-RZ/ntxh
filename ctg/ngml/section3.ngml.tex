...
\begin{sentenceList}\sentenceItem{} \swl{itm:isJones}{Is Jones there?}{pra}
...
of any scenario dscribed to us from afar.  When presented with
...
Mathematics \mdash{} and by extention formal logic as a 
...
Contintental Philosophy were widely seen as 
methodologically flawed, compared to the 
systematized argumentation presentated by the likes 
...
divorce between Analytic and Continental Philosopy. 
}
...
and unique resolution can be demostrated 
...
is of only indirectly relevance to 
computer implementations.
}
\p{Likewise, it seems, the mere presence of abstract 
structures which can be formalized from mental 
...
point to topics in compter science that could be 

...
Different phrases ehibit different levels of entrenchment:
...
\begin{sentenceList}\sentenceItem{} \swl{itm:coffeeshirt}{There's some coffee on your shirt.}{ref}
...
\begin{sentenceList}\sentenceItem{} \swl{}{There are coffees all over the far wall at the expresso bar.}{ref}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:NYboroughs}{New Yorkers live in one of five boroughs.}{ref}
...
Consider
\begin{sentenceList}\sentenceItem{} \swl{itm:pf}{People fed the rescued dogs.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{}{Every singer performed two songs.}{sem}
...
that \i{sing along} nudjes scope interpretation in one direction
and \i{perform} nudjes in a different direction.
...
\begin{sentenceList}\sentenceItem{} \hspace{-3pt}\swl{}{The trade rescued a star athlete from a losing team.}{idi}
...
\begin{sentenceList}\sentenceItem{} \swl{}{My favorite band gave a free concert last night.
...
\begin{sentenceList}\sentenceItem{} \swl{tour}{The band planned a tour, where
...
the esssential notion of \i{sets} themselves, 
...
Compare:
\begin{sentenceList}\sentenceItem{} \swl{itm:rhinor}{Rhinos in that park are threatened by poachers.}{sem}
...
In, say, 
\begin{sentenceList}\sentenceItem{} \swl{}{Let's find a restaurant that's family-friendly.}{sem}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{}{I got glue for your daughter.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{}{We're going to Grandma!}{sem}
...
rhetorical effect emphasizing that the recurrance of some 
phenomenon is tedious or noteworthy \mdash{} in this one usage \i{after} 
becomes a pluralizing adjevtive that takes two arguments, but 
requries them to be the same.  This sense of \i{after} can be 

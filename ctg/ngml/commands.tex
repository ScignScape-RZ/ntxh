...
.^^J%
^^J%
- p=page s=ud source, section number a=archival ^^J%
  i=id l=label x=latex label t=text r=pre o=post ^^J%
.^^J%
^^J%
&type SentenceList [8;3;2] ^^J%
  :i:1 :p:2 :s:3 ;^^J%
^^J%
&type SentenceItem {9} ^^J%
  :i:1 :p:2 :x:3 :t:4 :s:5 :l:6 :r:7 :o:8 :a:9 ;^^J%
^^J%
&/^^J%
^^J%
}}
...
\makeatletter
\newcommand{\writeNtxhSentenceItem}[5]{%
...
%\newcommand{\swl}[2]{\writeNtxhSentenceItem{#1}{#2}%
%\label{#1}{#2}}

\usepackage{xargs}
\newcommandx{\swl}[5][2,4,5]{\writeNtxhSentenceItem{#1}{#3}{#2}{#4}{#5}%
\label{#1}{#2}{ }{#3}{ }{#4}}

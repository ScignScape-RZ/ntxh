...
.^^J%
^^J%
- p=page s=ud source, section number r=pre ^^J%
  i=id l=label x=latex label t=text o=post ^^J%
.^^J%
^^J%
&type SentenceList [8;3;2] ^^J%
  :i:1 :p:2 :s:3 ;^^J%
^^J%
&type SentenceItem {8} ^^J%
  :i:1 :p:2 :x:3 :t:4 :s:5 :l:6 :r:7 :o:8 ;^^J%
^^J%
&/^^J%
^^J%
}}
...
\newcommand{\writeNtxhSentenceItem}[4]{%
...
\usepackage{xargs}
\newcommandx{\swl}[4][2,4]{\writeNtxhSentenceItem{#1}{#3}{#2}{#4}%
\label{#1}{#2}{ }{#3}{ }{#4}}

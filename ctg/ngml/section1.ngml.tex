...
\begin{sentenceList}\sentenceItem{} \swl{itm:having}{His having lied in the past damages his credibilty in the present.}{syn}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:grandma}{Let's go to Grandma.}{syn}
...
Combinatory Categorial Grammar; e.g., \cite{BiskriDescles}).  
...
\begin{sentenceList}\sentenceItem{} \swl{itm:black}{I saw my neighbor's two black dogs.}{sem}
...
a day: 
\begin{sentenceList}\sentenceItem{} \swl{itm:vet}{We have to wait until after the vet's two latest dogs.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:boatmen}{Boatmen rescued dogs from the flooded streets.}{sem}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:boroughs}{All New Yorkers live in one of five boroughs.}{sem}
...
Consider: 
\begin{sentenceList}\sentenceItem{} \swl{itm:beat}{The Leafs failed to beat the Habs for the first time this year.}{amb}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:allresidents}{All residents of the city of New York live in one of five boroughs.}{log}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:parked}{I am parked out back.}[(example 3, page 371)]{ref}
\sentenceItem{} \swl{itm:waiting}{I am parked out back and have been waiting for 15 minutes.}
[(example 3)]{ref}
...
\sentenceItem{} \swl{itm:Sauturnes}{I drank two Sauturnes last night.}[(page 375)]{ref}
\end{sentenceList}  
...
beverage, while (\ref{itm:Sauturnes}) implies two samples of 
...
(\ref{itm:parked})-(\ref{itm:Sauturnes}) are comfortable.  
...
(\ref{itm:autoshop}) 
\begin{sentenceList}\sentenceItem{} \swl{itm:library}{I'm in the library.}[(said by an author whose books are there)]{ref}
\sentenceItem{} \swl{itm:autoshop}{I've been in the auto shop for the 
last 15 days.}{ref}
\end{sentenceList}  
Nunberg attributes these discrepancie to cultural conventions, like the 
...
\begin{sentenceList}\sentenceItem{} \swl{}{My car is parked out back and have been waiting for 15 minutes.}{log}
\sentenceItem{} \swl{}{I drank two pints of beer last night.}{log}
\sentenceItem{} \swl{}{I tried two different Sauturnes last night.}{log}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:threetimes}{Three times, students asked an interesting question.}{sco}
\end{sentenceList}
...
\begin{sentenceList}\sentenceItem{} \swl{itm:threes}{Three students asked interesting questions.}{log}
\end{sentenceList}
...
paper to compain about my grade(s).}[]{sco}%
...
\mdash{} complained about the tuition increase.}[]{sco}%
...
structure \mdash{} for example, Applicative and Cognitive Grammar considers phrases
...
or cognitively supercede a more transparent logical meaning.  
...
\begin{sentenceList}\sentenceItem{} \swl{itm:tumour}{It is the most common tumour found in babies, occurring in one of every 35,000 births.}{log}
...
case-studies: 
\begin{sentenceList}\sentenceItem{} \swl{itm:ants}{A furry black band of ants led up a cupboard door to some scrap that had flicked from a plate.}{sem}

...
\begin{sentenceList}\sentenceItem{} \label{itm:having} His having lied in the past damages his credibilty in the present.
...
\begin{sentenceList}\sentenceItem{} \label{itm:grandma} Let's go to Grandma.
...
\p{Type-Theoretic Semantics holds out the hope that many 
...
\begin{sentenceList}\sentenceItem{} \label{itm:black} I saw my neighbor's two black dogs.
...
a day: 
\begin{sentenceList}\sentenceItem{} \label{itm:vet} We're going after the vet's two latest dogs.
...
\begin{sentenceList}\sentenceItem{} \label{itm:boatmen} Boatmen rescued dogs from the flooded streets.
...
\begin{sentenceList}\sentenceItem{} \label{itm:boroughs} All New Yorkers live in one of five boroughs.
...
Consider: 
\begin{sentenceList}\sentenceItem{} \label{itm:beat} The Leafs failed to beat the Habs for the first time this year.
...
\mdash{} i.e., that for yet another game they failed to score a goal.    
}
...
\begin{sentenceList}\sentenceItem{} \label{itm:allresidents} All residents of the city of New York live in one of five boroughs.
...
\subsection{Logical Structure versus Sentence Structure}
...
\begin{sentenceList}\sentenceItem{} \label{itm:tumour} It is the most common tumour found in babies, occurring in one of every 35,000 births.\udref{en_pud}{n01051007}
...
\p{For many philosophers of language, identiying similar 
...
case-studies: 
\begin{sentenceList}\sentenceItem{} \label{itm:ants} A furry black band of ants led up a cupboard door to some scrap that had flicked from a plate.

...
such as Bob Cocke and David Spivak \cite{BobCocke}).  
...
of linguistic phenomena, as articulated by (say) 
Olav K. Wiegand (\cite{OlavKWiegand}) 
...
construction, translation, and pipeling between and among 
...
automatically, given raw linguistic input. 
}
...
without some structural autonomy: it's reasonable to 
...
sentence on a spectrum where extralinguistic and (I'll say) 
...
$$\begin{matrix}
  \text{Logicomorphic}  & --- & \text{Extra-Linguistic} \\
     \| & &  \| \\
  \text{Intra-Linguistic}  & ---   &  \text{Interpretive}
\end{matrix}$$
...
compositional pattern that can be analyzed \i{either} at the 
...
complete vacuous, but is general and underspecified enough to 

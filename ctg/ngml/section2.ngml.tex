...
Given, say, 
\begin{sentenceList}\sentenceItem{} \swl{itm:ambience}{The city's ambience is colonial and the climate is tropical.}
...
\begin{sentenceList}\sentenceItem{} \swl{actually}{The most popular lodging is actually camping on the beaches.}
...
Figure~\ref{fig:actuallydbl}, with the double-indices can be juxtaposed 
with conventional Dependency labels (the indices below the sentence, 
...
\sentenceItem{} \swl{office}{Many students came by my office to complain about their grades.}
\sentenceItem{} \swl{after}{Student after student complained about the tuition hikes.}
...
\sentenceItem{} \swl{}{Three times, a student asked an interesting question.}
\end{sentenceList}
...
(`cite<>; has an interesting review of a similar 
...
\begin{sentenceList}\sentenceItem{} \swl{}{The newspaper you are reading is being sued.}
\sentenceItem{} \swl{}{Liverpool, an important harbor, built new docks.}
\end{sentenceList}
...
the table.}[(?)]
\sentenceItem{} \swl{}{Liverpool beat Tottenham and built new docks.}[(?)]
\end{sentenceList}
...
in those terms:
\begin{sentenceList}\sentenceItem{} \swl{}{Liverpool wants to sign a left-footed striker.}
\sentenceItem{} \swl{}{That newspaper plans to fire its editorial staff.}
\end{sentenceList}

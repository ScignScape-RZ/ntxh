...
what Part of Speech is consisent for various words given syntactic 
...
of (\ref{itm:Sauturnes}).  I do not find
...
apparent difference between (\ref{itm:Sauturnes}) and
...
(\ref{itm:crate}) or \i{I am in that crate} (which Nunberg rejects).  

...
\p{Suppose many CyberPhysical sensors were paired 
...
CyberPhysical interfaces; here Natural Language 
...
which process CyberPhysical data should rigorously organize their functionality
...
\p{I have argued that hub \i{libraries} \mdash{} intermediaries between CyberPhysical 

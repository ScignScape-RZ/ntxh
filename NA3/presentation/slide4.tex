...
{\LARGE \begin{itemize}
\item \q{Qt Cloud Services} Discontinued in 2016.\vspace{1em}
\item  Currently there is no standard model for accessing 
Cloud services from Qt applications.\vspace{1em}
\item  Nor is there a standard Qt-based Cloud/Native container architecture.
\\\vspace{1.5em}

...
{\Large\begin{itemize}
\item {\lsep} \parbox[t]{18.5cm}{A3R Applications are self-contained, citable resources which 
can conform to \makebox{modern} resource documentation standards, such as the 
Research Object protocol.}
\vspace{.8em}
\item {\lsep} \parbox[t]{18.8cm}{A3R Applications can use Hypergraph-structured metadata 
...
\begin{itemize}
\item {\lsep} Hypergraph-based data modeling and serialization.
\vspace{.5em}  
\item {\lsep} Framework for building custom scripting, parsing, and data persistence engines.
\vspace{.5em}   
\item {\lsep} Enhanced support for applications specifically designed to access research data 
sets. \vspace{.5em} 

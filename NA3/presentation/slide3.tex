...
{\centerline{\LARGE\color{darkRed!50!red} \textbf{The 
			Application-as-a-Resource (A3R) Model}}}
\vspace{1em}
...
\vspace{.8em}
\sqitem {\lsep} \parbox[t]{18.8cm}{A3R includes a 
...
\begin{itemize}
\sqitem {\lsep} \parbox[t]{19cm}{NA3 incorporates Semantic Web alternatives 
with greater Requirements Engineering and Quality 

...
\begin{frame}{\ft{Our NCN (Native Cloud/Native) Protocol for Cloud Back-Ends}}
	\section{NCN}
\vspace{-3em}	
...
{\Large \begin{itemize}
\sqitem {\lsep} \parbox[t]{17cm}{Our \q{Native Cloud/Native} service is also a protocol, which 
governs native application front-ends paired with 

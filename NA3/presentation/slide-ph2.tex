...
\doubleFrameY{1.01\textwidth}{-10pt}{1.005\textwidth}{\textwidth}{4pt}{\AtR{} programming can also bring enhanced UX 
to Real Estate presentations: instead of just groups of 
photos, properties can be displayed via interactive, 
multi-dimensionally organized, color-coded photo viewers.}

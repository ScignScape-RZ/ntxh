			...
			\fcolorbox{fcBoxColor!50!cyan}{white}{%
				\begin{minipage}{#2}%
					\begin{center}\begin{minipage}{.97\textwidth}				
							\begin{spacing}{1.8}\vspace{.5em}\part{title}{\textbf{\Large #3}\vspace{-20pt}}\end{spacing}%
...
\begin{minipage}{#3}%
					\begin{center}\begin{minipage}{#4}				
							\begin{spacing}{1.8}\vspace{.5em}\part{title}{\textbf{\Large #6}\vspace{-20pt}}\end{spacing}%
						\end{minipage}\end{center}
					\end{minipage}}
					%\end{center}
				\end{minipage}}

...
{\bf \begin{itemize}
\sqitem  {\lsep} Export data and instructions between Qt-based applications (slides 12-13).\vspace{1em}
\sqitem  {\lsep} \parbox[t]{15cm}{Embed document or multi-media viewers inside scientific or 
dataset applications (slides 24-27).}\\\vspace{1.5em}
...
Real Estate, VR, etc. (slides 17-23).}\vspace{1em}

...
{\bf \begin{itemize}
\sqitem  {\lsep} Export data and instructions between Qt-based applications (slides 14-15).\vspace{1em}
\sqitem  {\lsep} \parbox[t]{15cm}{Embed document or multi-media viewers inside scientific or 
dataset applications (slides 26-29).}\\\vspace{1.5em}
...
Real Estate, VR, etc. (slides 19-25).}\vspace{1em}

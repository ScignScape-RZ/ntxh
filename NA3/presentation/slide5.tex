...
{\bf \begin{itemize}
\sqitem Export data and instructions between Qt-based applications (slides 6-7).\vspace{1em}
\sqitem Embed document or multi-media viewers inside scientific or 
...
\end{minipage}}}
 \vspace{1em}
\begin{itemize}
\sqitem  Compelling front-ends for e-commerce, Real Estate, VR, etc. (slides 11-17).\vspace{1em}

\sqitem  For scientists and researchers, 

...
Document viewers would therefore support an interactive, multimedia reading 
experience to an unprecedented degree, 
which would especially benefit students during test 
preparation.  
In particular, students would have at their 
disposal pedagogically stimulating multimedia presentations that offer sophisticated 
...
with instructional features introduced as 
supplements to the documents which students 
...
\mnote{How \iEPF{} enables multi-appli- cation networking}%\\\vspace{27em}}
\p{\begin{wrapfigure}[10]{r}{110mm}
\vspace{-1.4em}\input{etsf1.tex}
\end{wrapfigure}
...
\vspace{-1em}
\input{etsf2.tex}
\end{wrapfigure}\vspace{.2em}\noindent{}\XPDF{}). \hspace{4pt}The \XPDF{} plugin would then
...
\p{\begin{wrapfigure}[12]{r}{110mm}
\vspace{-1em}\input{etsf3.tex}
	\end{wrapfigure}
...
{\sectsp}\vspace{-.5em}
\mnote{\iEPF{} data\\in em-\\bedded files}
\p{In most cases, \EPF{} plugins for document viewers such as 
...
document elements requiring special \EPF{} actions.  For questions (4) and 
(95) as illustrated above, the relevant 
...
between applications --- in Figure~\bref{fig:tc}, for example, 

...
\begin{description}
\item[\parbox{14cm}{Scenario 1: A student reads textbooks, articles, 
or test-preparation materials which may be enhanced 
with multi-media content}]  To enhance the reading 
...
\item[Scenario 3: Integrated Development Environments 
(\IDE{}s) may be used as teaching tools]  

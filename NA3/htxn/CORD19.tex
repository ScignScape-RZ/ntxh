...
\geometry{left=.78in,top=1.1in,right=.6in,bottom=1.5in} %margins
...
data) so as to enhance their interoperability and 
...
data sets indexed by our \SDK{} alongide matches within textual content.  As a concrete example, 

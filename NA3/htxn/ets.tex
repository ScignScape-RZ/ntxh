...
so that students benefit from an inteactive, multi-media 
...
\p{\begin{wrapfigure}{r}{115mm}
		\input{etsf5.tex}
	\end{wrapfigure}In general, the functionality provided by each ETS plugin will 
...
between applications via plugins.  The 
\q{request info} tab allows students, instructors, 

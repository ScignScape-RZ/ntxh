...
Moreover, while studying for exams, interactive multimedia presentations 
...
\input{etsf0.tex}
\mnote{Employing \iEPF{} as\\test-taking software}
...
In manuscripts (such as the ETS \GRE{} practices) where 
...
SOCl$_2$ (this file is available from the \q{Chemical Abstracts Service} database). %\hspace{.5em} 
The relation between the specific textual location  

...
In some cases, however, the information sent between plugins might 
...
As this example illustrates, the plugins' data-sharing functionality makes both applications more 
...
\setlength{\textfloatsep}{10pt}\setlength{\belowcaptionskip}{4pt}\input{etsf6.tex}
...
\setlength{\intextsep}{8pt}\setlength{\belowcaptionskip}{4pt}\input{etsf0.tex}

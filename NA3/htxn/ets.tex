...
linked to the documents (viv., the test-preparation materials) 
...
\hspace{2pt}SOCl$_2$\hspace{2pt} file to IQmol's own}
...
Figure~\bref{fig:i1}, the highlighted option where the 
cursor is pointing).
The end result, then,  
...
application-states (see the Model View panel at 
the top-left on 
Figure~\bref{fig:i2}) when needed.}
%\input{etsf4.tex}

\p{\begin{wrapfigure}[14]{l}{115mm}\vspace{-1.5em}
\input{etsf5.tex}%
...
(see Figure~\bref{fig:xss}) 
	as well as a more detailed review of the data 
...
\p{In most cases, ETS plugins for document viewers such as 

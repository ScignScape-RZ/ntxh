...
\geometry{left=.78in,top=1.1in,right=.6in,bottom=1.8in} %margins
...
adopt as an editor can provide a prototype which 
can be adapted by journals that can feed articles 
...
context.  By providing a self-contained computing 
...
expertise which may lie outside researchers' 
disciplinary scope.}  

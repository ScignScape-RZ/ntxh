...
\usepackage[paperheight=14in,paperwidth=9in]{geometry}
...
\newcommand{\TThreeK}{{\color{red!15!black}%
{\fontfamily{qhv}\selectfont {T3K}}}}
...
\newcommand{\CCpp}{\resizebox{!}{7.5pt}{\AcronymText{C}}/\Cpp{}}
\newcommand{\NoSQL}{\resizebox{!}{7.5pt}{\AcronymText{NoSQL}}}
\newcommand{\SQL}{\resizebox{!}{7.5pt}{\AcronymText{SQL}}}

\newcommand{\NCBI}{\resizebox{!}{7.5pt}{\AcronymText{NCBI}}}

\newcommand{\HTXN}{\resizebox{!}{7.5pt}{\AcronymText{HTXN}}}
...
\newcommand{\PVD}{\resizebox{!}{7.5pt}{\AcronymText{PVD}}}

\newcommand{\THQL}{\resizebox{!}{7.5pt}{\AcronymText{THQL}}}
\newcommand{\lTHQL}{\resizebox{!}{8pt}{\AcronymText{THQL}}}

\newcommand{\SDK}{\resizebox{!}{7.5pt}{\AcronymText{SDK}}}
\newcommand{\NLP}{\resizebox{!}{7.5pt}{\AcronymText{NLP}}}



\newcommand{\sapp}{\resizebox{!}{7.5pt}{\AcronymText{Sapien+}}}
\newcommand{\lsapp}{\resizebox{!}{8.5pt}{\AcronymText{Sapien+}}}
\newcommand{\lssapp}{\resizebox{!}{9.5pt}{\AcronymText{Sapien+}}}

\newcommand{\ePub}{\resizebox{!}{7.5pt}{\AcronymText{ePub}}}
...
\newcommand{\LPF}{\resizebox{!}{7.5pt}{\AcronymText{LPF}}}
...
\newcommand{\EPF}{\resizebox{!}{7.5pt}{\AcronymText{ETS{\color{pfcolor}pf}}}}
...
\newcommand{\XML}{\resizebox{!}{7.5pt}{\AcronymText{XML}}}
\newcommand{\RDF}{\resizebox{!}{7.5pt}{\AcronymText{RDF}}}
\newcommand{\DOM}{\resizebox{!}{7.5pt}{\AcronymText{DOM}}}

\newcommand{\CLang}{\resizebox{!}{7.5pt}{\AcronymText{C}}}

\newcommand{\HNaN}{\resizebox{!}{7.5pt}{\AcronymText{HN%
\textsc{a}N}}}

\newcommand{\JSON}{\resizebox{!}{7.5pt}{\AcronymText{JSON}}}

\newcommand{\MeshLab}{\resizebox{!}{7.5pt}{\AcronymText{MeshLab}}}
\newcommand{\IQmol}{\resizebox{!}{7.5pt}{\AcronymText{IQmol}}}

\newcommand{\SGML}{\resizebox{!}{7.5pt}{\AcronymText{SGML}}}

\newcommand{\GUI}{\resizebox{!}{7.5pt}{\AcronymText{GUI}}}

\newcommand{\API}{\resizebox{!}{7.5pt}{\AcronymText{API}}}

\newcommand{\SDI}{\resizebox{!}{7.5pt}{\AcronymText{SDI}}}

\newcommand{\IDE}{\resizebox{!}{7.5pt}{\AcronymText{IDE}}}

\newcommand{\ThreeD}{\resizebox{!}{7.5pt}{\AcronymText{3D}}}

\newcommand{\FAIR}{\resizebox{!}{7.5pt}{\AcronymText{FAIR}}}

\newcommand{\QNetworkManager}{\resizebox{!}{7.5pt}{\AcronymText{QNetworkManager}}}
\newcommand{\QTextDocument}{\resizebox{!}{7.5pt}{\AcronymText{QTextDocument}}}
\newcommand{\QWebEngineView}{\resizebox{!}{7.5pt}{\AcronymText{QWebEngineView}}}
\newcommand{\HTTP}{\resizebox{!}{7.5pt}{\AcronymText{HTTP}}}
...
\newcommand{\iXPDF}{\resizebox{!}{7.5pt}{\textsccserif{%
\textit{XPDF}}}}

\newcommand{\iEPF}{\resizebox{!}{7.5pt}{\textsccserif{%
\textit{ETSpf}}}}

\newcommand{\iSDI}{\resizebox{!}{7.5pt}{\textsccserif{%
\textit{SDI}}}}

\newcommand{\iHTXN}{\resizebox{!}{7.5pt}{\textsccserif{%
\textit{HTXN}}}}
...
\newcommand{\FASTA}{{\resizebox{!}{7.5pt}{\AcronymText{FASTA}}}}
\newcommand{\SRA}{{\resizebox{!}{7.5pt}{\AcronymText{SRA}}}}
\newcommand{\DNA}{{\resizebox{!}{7.5pt}{\AcronymText{DNA}}}}
\newcommand{\MAP}{{\resizebox{!}{7.5pt}{\AcronymText{MAP}}}}
\newcommand{\EPS}{{\resizebox{!}{7.5pt}{\AcronymText{EPS}}}}
\newcommand{\CSV}{{\resizebox{!}{7.5pt}{\AcronymText{CSV}}}}
\newcommand{\PDB}{{\resizebox{!}{7.5pt}{\AcronymText{PDB}}}}

\newcommand{\TeXMECS}{\resizebox{!}{7.5pt}{\AcronymText{TeXMECS}}}

\newcommand{\NGML}{\resizebox{!}{7.5pt}{\AcronymText{NGML}}}

\newcommand{\Cpp}{\resizebox{!}{8.5pt}{\AcronymText{C++}}}

\newcommand{\WhiteDB}{\resizebox{!}{7.5pt}{\AcronymText{WhiteDB}}}

\colorlet{drp}{darkRed!70!purple}

%\newcommand{\MOSAIC}{{\color{drp}{\AcronymTextNC{\scriptsize{MOSAIC}}}}}

\newcommand{\MOSAIC}{\resizebox{!}{7.5pt}{\AcronymText{MOSAIC}}}
...
\newcommand{\sMOSAICVM}{\resizebox{!}{7.5pt}{\MOSAICVM}}
\newcommand{\sMOSAIC}{\resizebox{!}{7.5pt}{\MOSAIC}}

\newcommand{\LDOM}{\resizebox{!}{7.5pt}{\AcronymText{LDOM}}}
\newcommand{\Cnineteen}{\resizebox{!}{7.5pt}{\AcronymText{CORD-19}}}


\newcommand{\LXCR}{\resizebox{!}{7.5pt}{\AcronymText{LXCR}}}
...
\newcommand{\Mosaic}{\resizebox{!}{7.5pt}{\MOSAIC}}
\newcommand{\MosaicPortal}{{\color{drp}{\AcronymTextNC{MOSAIC Portal}}}}

\newcommand{\RnD}{\resizebox{!}{7.5pt}{\AcronymText{R\&D}}}
\newcommand{\QtCpp}{\resizebox{!}{8.5pt}{\AcronymText{Qt/C++}}}
\newcommand{\Qt}{\resizebox{!}{7.5pt}{\AcronymText{Qt}}}
\newcommand{\QtSQL}{\resizebox{!}{7.5pt}{\AcronymText{QtSQL}}}

\newcommand{\HTML}{\resizebox{!}{7.5pt}{\AcronymText{HTML}}}
\newcommand{\PDF}{\resizebox{!}{7.5pt}{\AcronymText{PDF}}}
...
\renewcommand{\LaTeX}{\resizebox{!}{7.5pt}{\color{orr!35!black}{\OldLaTeX}}}

\let\OldTeX\TeX

\renewcommand{\TeX}{\resizebox{!}{7.5pt}{\color{orr!35!black}{\OldTeX}}}
...
\hspace{-9pt}\begin{minipage}{1.04\textwidth}	
\begin{center}		
{\setlength{\fboxsep}{12pt}
	\relscale{1.4}{{\fontfamily{qcr}\fontseries{b}\selectfont%
{Proposing a CORD-19 SDK to Improve Machine Readability \\
 {\fontsize{12}{14}\selectfont TO COORDINATE WITH SPRINGER NATURE, WILEY, ELSEVIER, the AMERICAN SOCIETY FOR MICROBIOLOGY, 
...
\begin{center}\parbox{0.8\textwidth}{\color{red!60!black}
...
protocol, which may be especially important at the 
...
arguably poorly designed for this priority.  Neither the article 
...
additional curation.  The files inluded in this 
...
The point here is not to recommend a direct generalization of 
PurpleData --- indeed, PurpleData (implemented in Python) is 
not an ideal case-study in prototyping/simulation techniques 
because it is not legitimately self-contained.  
One could argue that alternative technologies, 
such as WhiteDB --- 
an under-appreciated database engine (an \SQL{}/\NoSQL{} hybrid) 
currently used for 
certain CyberPhysical and 
telemedical systems --- would be a more definitive framework for prototyping 
...
\p{One important goal of the Research Object protocol 
...
as ReproZip.  An alternative solution, arguably more 
in keeping with the vision of truly \textit{self-contained} 
Research Objects, is to provide a kind of out-of-the-box 
...
might be called a \q{triple-kernel} (or 
\TThreeK{}, for transparent-triple-kernel) architecture, 
referring to database, data visualization, and 
scripting engines.  A good prototype for 
triple-kernel implementation would use 
...
\p{A fully self-contained \TThreeK{} 
...
respective \TThreeK{} kernels (in the prototype case, 
to the WhiteDB, AngelScript, and \Qt{} engines respectively).  
A canonical WhiteDB/AngelScript/\Qt{} \TThreeK{} framework 
can be facilitated by a Standard Development Kit, 
extending the AngelScript \SDK{} with WhiteDB and 
\Qt{} integration.}

\p{Having described a \TThreeK{} model for \textit{individual} 
...
extending a \TThreeK{} \SDK{} with domain-specific 
...
\p{This discussion has highlighted limitations of data 
...
achieve this is via a \TThreeK{} architecture 

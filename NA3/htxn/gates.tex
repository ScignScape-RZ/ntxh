...
\newcommand{\THQL}{\resizebox{!}{8pt}{\AcronymText{THQL}}}
\newcommand{\lTHQL}{\resizebox{!}{8pt}{\AcronymText{lTHQL}}}
...
a  \q{Covid-19 Open Research Dataset} (CORD-19) that was 
...
\q{Although the goal of opening these materials for 
access to the general public is, at least in part, 
to spur \textit{data mining} for Covid-19 research, 
all of the resources aggregated via CORD-19 are 
...
some time before CORD-19 was officially announced --- 
illustrates the limitations of this relatively unstructured 
data-publishing appoach.  (In reality, Springer Nature 
allows readers to browse articles in \HTML{} within their 
web portal; with other CORD-19 resources it is actually 
...
additional effort.  In particular, Research Object should 
...
as ReproZip.  Another solution, arguably more 
...
for raw data published throuh an integrated research portal; 

...
\geometry{left=.8in,top=1.1in,right=.62in,bottom=1.8in} %margins
...
as future volumes in the \textit{Advances in Ubiquitous 
Sensing for Healthcare} series.  It is certainly possible 
that some future articles in this series will be 
relevant to Covid-19; indeed, remote diagnosis and 
cyber-physical screening devices are an important 
...
directly to \Cnineteen{} or similar initiatives.  
...
machine-readable information space.
...
converted to numerical formats to work with 
\Cnineteen{} overall.\footnote{%
...
not all Covid-19 data is practical 

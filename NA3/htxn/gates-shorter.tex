...
series editor of \q{Speech Technology and 
Text Mining in Health Care} (published by de Gruyter), 
and Editor of textit{Advances in Ubiquitous Computing: 
Cyber-Physical Devices, Smart Cities, 
and Ecological Montioring}. 
(published by Elsevier, forthcoming).
...
initiative to spur \hspace{2pt} Covid-19 research.  
...
errors) whenever they are available, 
as a supplement to \Cnineteen{}'s 
\JSON{} representation.  The \SDK{} would then provide tools to 
...
\item[Tools for Research Data-Mining]  In 
...
through \Cnineteen{}.  Nevertheless, 
...
includes over 30 \Covid{} data sets.  
These data sets encompass a wide array of file types 
...
and Excel formats.  To promote data
...
platform optimized for scienctific research 
...
proposed \SDK{} would include a \textit{data-modeling 
...
fine-grained reference into a data set.  For example it 
can consist of one column in a spreadsheet, 
one statistical parameter in a quantitative analysis, 
or \q{the precise data records actually used in a study} (as 

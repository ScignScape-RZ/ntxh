...
{Proposing a CORD-19 Software Development Kit}
}}}
\end{center}
\end{minipage}
\end{tcolorbox}
...
\p{To help scientists utilize \Cnineteen{}, my company, 
Linguistic Technology Systems, proposes to create a Software 
Development Kit (\SDK{}) that would facilitate the deployment of 
software targeting \Cnineteen{}.  This \SDK{} 
...
research.  The White House announcement requests 
institutions to develop additional technologies 
which would help scientists and jurisdictions to 
take advantage of \Cnineteen{}.  In short, \Cnineteen{} was released with the 
...
\p{Our proposed \SDK{} would include a collection of 
...
\JSON{} representation.  Because the alternate 

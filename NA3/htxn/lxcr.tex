...
{Scientific/Multi-Media Application Plugins for 
...
\p{Complementing \LXCR{}'c Document Object Model 
...
and/or multi-media content.  \lLXCR{} is designed for a 
contemporary publishing industry where individual 
books or articles are only one part of a network 
encompassing text, data, and multi-media resources.  
...
multi-media files which help readers visualize or 
...
integrate disparate reading, technical, and multi-media 
applications into a unified e-reading platform.
}

\p{
Given that a full publication package (not just  
...
as \q{the} e-reader used to access the publication.  
...
this software must know how to respond to the data 
sent from the document viewer.  This kind of inter-operability 
...
\p{
This paper will present further information about both 
aspects of LXCD --- the Document Object Model and the 
...
to the document structure, which in turned is modeled 
by a Document Object Model.  For example, each 
supplemental multimedia resource (such as a \ThreeD{} graphics 
model) is particularly relevant at specific locations in the 
...
embedded at the point publication where the protein is 
mentioned or analyzed in the publication.  It is not 
...
\p{
This specific example --- embedding visual cues and 
...
publication viewers and scientific or multi-media 
applications (loading individual multi-media resources 
...
{\sectsp}  
\p{
The goal of \LPF{} is to augment scientific and 
...
\mlitem[Scenario 3: A student launches an Integrated Development Environment (\IDE{}) which is used as a teaching tool]  
...
\mlitem[Scenario 4: Authors Develop Educational 
...
multi-media files.  For example, files in the 
...
document viewers and scientific/multi-media software.  
This situation applies when it is useful for readers not 
view particular multi-media files in domain-specific 
...
external software, such as scientific/multi-media 
...
multi-media or technical content specifically 
...
of multi-media applications which augment 

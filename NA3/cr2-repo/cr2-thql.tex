...
structures into a common structure.  
...
in greater detail, followed afterword by 
...
of course, are not required to compile all files 
to a hypergraph format; in particular, 
scientific fields requiring substantial quantitative 
analysis --- e.g., biomechanics or genomics --- 
express data via encodings optimized for relevant 
mathematical operations, and have parser libaries 
optimized for these specific formats.  However, even for 
...
\p{As indicated by its name, \THQL{} is 
...
\THQL{} operational modes, \DgDb{} organizes a 

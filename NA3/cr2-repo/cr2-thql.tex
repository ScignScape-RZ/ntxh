...
machine-readable archive.  In addition, \CRtwo{} will 
...
Research Objects (discussed below).  \lCRtwo{} will demonstrate 
\THQL{} via a new database engine called DigammaDB 
(or \q{\DgDb{}}) which 
serves as a \q{Reference Implementation} for 
\THQL{}.  In \CRtwo{}, \DgDb{} is 
...
engine tailored to individual projects' 
data storage and 
application-development requirements 
(please see contact information at the end of 
this paper to schedule a consultation).} 
...
The preeminent feature of Dataset Creator is 
...
to the Research Object's raw data, permitting 
...
\p{Having outlined the content and goals \CRtwo{}, the remaining sections 
will focus on the new technology underlying \CRtwo{}, 
technology with potential applications in many scientific and 
programming domains.   As described earlier, \THQL{} is a database 
...
Parsing a query language is then a 
...
A graph can then, if desired, be configured to only accept hypernodes 
...
hypergraph-encoding with WhiteDB in greater detail).  

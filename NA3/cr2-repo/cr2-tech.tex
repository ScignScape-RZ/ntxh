...
of text and data mining.  In building this \CRtwo{} repository, 
LTS will develop and demonstrate new database engineering 
and dataset/repository construction 
technologies.  As a companion to the \CRtwo{} archive, LTS is likewise 
compiling an archive called \q{\AIMConc{}} 
(Archive for \lAI{} Methodology and Conceptual Space Theory) 
...
and Part II will discuss the new database engineering 
and archive construction technologies 

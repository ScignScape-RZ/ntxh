...
\geometry{left=.78in,top=.5in,right=.79in,bottom=1.2in} %margins
...
(so as to promote specialized application implementation, 
accelerating research and documentation related to 
vaccine development) will expand the Vaccine Ontology to the domain of 
hypergraph ontologies.  More information on hypergraph ontologies, 

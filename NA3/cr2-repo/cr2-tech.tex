...
\geometry{left=.79in,top=.5in,right=.78in,bottom=1.2in} %margins
...
In short, \CRtwo{} and \AIMConc{} are structured 
...
\textit{hypergraph} ontologies --- that define schema 
...
\p{In the field of vaccine development and 
...
scientific understanding of effectiveness of vaccines 
depends on assessment of the immunological response 

...
\geometry{left=.7in,top=.5in,right=.7in,bottom=1.2in} %margins
...
technologies.  As a companion to \CRtwo{}, LTS is also 
compiling an additional methodology-focused archive 
called \q{\AIMConc{}} (Archive for \lAI{} Methodology and Conceptual Space Theory) 
featuring \AI{}-related code which can be concretely applied 
to \CRtwo{} data.  Part I of this paper will outline the \CRtwo{} 
and \AIMConc{} repositories; 
...
\section{Code Libraries and Data Sets for Analytic and AI Methodology}
\p{As a companion to \CRtwo{}, whose essential purpose 
is to present empirical observations concerning Covid-19, 
LTS is also curating the \AIMConc{} archive, which is focused 
on code supporting Artificial Intellegence and 
...
fuzzy sets/logic; and conceptual spaces.  So as to integrate this code into a 
common programming framework, the \AIMConc{} libraries are 
...
Here are some of the methodological approaches which, 
based in part on how Covid-19 research can provide 
concrete use-cases, will be important 
...
and an average level of person-to-person contact), 
often alongside empirical data tracking how a disease 
...
often emloying weighted graphs where edges denote, 
...
using custom quantitative algorithms composed 
...
Conceptual Space Markup Language (\CSML{}), which 
(in an updated form) \CRtwo{} will use to document scientific parameters 

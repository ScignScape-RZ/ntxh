...
vaccinological research.  As a result, the 
\q{Procedural Hypergraph Application Ontology for 
Vaccines and Immunization} (\PhaonVI{}) developed for 
\CRtwo{} can be associated with software tools 
similar to those which will be implemented 
for \HDICOM{}.}

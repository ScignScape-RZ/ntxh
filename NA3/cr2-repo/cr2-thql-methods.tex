...
\put(59,923){\textbf{{\fontfamily{phv}\fontsize{14}{14}\selectfont{}WHITE PAPER}}}
\fi
}	
...
\setlist[description]{%
  ...
  itemsep=25pt,               % space between items
...
\section{Data Sets for Analytic Methodology}
\p{In addition to raw data sets whose essential purpose 
is to present empirical observations concerning Covid-19, 
one section of \CRtwo{} will be devoted to archives 
illustrating analytic techniques which may be applied to 
\CRtwo{} data as a whole.  These \q{methodological} archives 
may include code libraries, real or hypothetical 
data sets curated specifically to test and/or document 
computational methods, or some combination thereof.  
Here are some of the methodological approaches which, 
in light of current Covid-19 research, will be important 
components of \CRtwo{}:
...
some object can (at least in an empirical system) be 

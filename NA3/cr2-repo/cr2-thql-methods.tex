...
\put(59,933){\textbf{{\fontfamily{phv}\fontsize{14}{14}\selectfont{}WHITE PAPER}}}
\fi
}	
...
\newcommand{\AIMConc}{\resizebox{!}{7pt}{\ATextClr{AIM-Concepts}}}

\newcommand{\THQL}{\resizebox{!}{7pt}{\ATextClr{THQL}}}
\newcommand{\lTHQL}{\resizebox{!}{7.5pt}{\ATextClr{THQL}}}
...
\setlist[description]{%
  ...
  itemsep=15pt,               % space between items
...
engineers --- in particular, hypergraphs, fuzzy sets, 
and conceptual spaces.  So as to integrate this code into a 
...
basid in part on Covid-19 research providing 
...
often alongside empirical data observing how a disease 

...
to publications.  Microcitations are also a tool for data mining, 
because a data set can be analyzed by examining each annotated 
element within the data set.}

...
applictions which are either too narrow or too broad 
in scope.  On the one hand, doctors often complain 
that homogenous Electronic Health Record systems (where 
...
should be neither too homogenous nor too isolated; finding the 
...
while also identifying requirments that are 
...
In short, the computational requirements 
...
themselves --- helping users identify and launch the 
software which is most directly relevant to their 
clinical or research needs at time moment.  Meanwhile, 
...
Analytic Processing, which again represents semi-automous 
software components jointly connecting to a central 
data hub.  Web applictions, too, often act as domain-specific 
...
develop multi-application in the context of more substantial, 
desktop-style scientific applications.  In short, 
...
The \Cnineteen{} corpus archived thousands of 
...
could allow them to pair text-form narratives with 
...
\p{As described earlier, and information space 
adapted for multiple peer applications can include 
...
against silhouettes (back, front, head, and so forth).  
...
application-persistence logic can be marshalled to 

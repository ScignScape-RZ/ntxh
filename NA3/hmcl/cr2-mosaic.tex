...
\newcommand{\lMdsX}{\resizebox{!}{8pt}{\ATextCClr{MdsX}}}
...
\newcommand{\MPF}{\resizebox{!}{7pt}{\AcronymText{MPF}}}
...
\p{The \MOSAIC{} Data-Set Explorer (\MdsX{}), to be 
specific, is a suite of 
...
from the perspective of these these technologies.}
...
\p{The overall \MOSAIC{} framework, then, 
spans three different technical areas.   
...
via \HMCL{}.  These workflows allow different 
...
users to manually save and then reopen files.}
...
be disussed in the next section.}
\input{pics/rad3}
...
within a broader \MOSAIC{} annotation system, described 
below.  A rigorous overview of this annotation 
...
called \q{Hypergraph Exchange Format} 
(\HGXF{}) --- and provides a light-weigth database 
engine (called \DgDb{}) for persistent 
...
In the ideal case, an \MdsX{} notebook will link 
...
in more complex cases the data involves 
multiple types.  In either case, the 
...
in Figures~\ref{fig:i2} and \ref{fig:x2}, 
showing two applications using a \MOSAIC{} 
plugin to interoperate.  Figure~\ref{fig:i2} 
demonstrates how users may view 
basic plugin info.  Figure~\ref{fig:x2} 

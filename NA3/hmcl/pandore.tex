...
\newcommand{\ConceptsDB}{\resizebox{!}{7pt}{\AcronymText{ConceptsDB}}}
...
{\setlength{\fboxsep}{32pt}
	\relscale{1.2}{{\fontfamily{qcr}\fontseries{b}\selectfont%
{The \llMOSAIC{} Structured Reporting Framework 
and Image Processing Objectives Description}
}}}
\end{center}
\end{minipage}
\end{tcolorbox}
...
domain-specific recommendations collectively 
...
allowing users to access new code's functionality 
...
draw clinical data from \DICOM{} headers, and 
represented this extracted information via \RDF{}.  
...
library, though important many constructs 
...
\textit{about} a serialization --- is 
...
In short, \MOSAIC{} provides parsers for an 
extended version of \TAGML{} which includes 
an addition \q{grounding} layer.  Grounding, 
...
which can output serialized data as conventional 
...
are structured overview of application-level 
data types.  To fulle utilize \GTagML{} features, 
programmers would then compose \q{infoset classes} 

...
locality.\footnote{These are familiar critiqued, but 
...
building technologies to integrate heterogenous 
...
these initiatives.  The important consideration, 
then, is how to employ hypergraphs as an extension 
...
these schemas to the Controled Vocabularies 
...
In general, these hypergraph construction represent 

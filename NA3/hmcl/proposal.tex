...
\geometry{left=.72in,top=.5in,right=.73in,bottom=1.2in} %margins
...
custom software.  Figure~\ref{fig:oxy} illustrates 
...
Dr. James Rodger (Principle Investigator 
...
in the article text; Figure~\ref{fig:about} shows 
...
developed for two academic volumes.  This includes a 
forthcoming Elsevier volume titled \textit{Cross-Disciplinary Data 
Integration and Conceptual Space Models for Covid-19}, 
co-authored by Dr. Amy Neustein and Nathaniel Christen 
...
\HMCL{} languages described here), and a volume 
focused on medical image processing, titled 
\textit{Medical Image Processing and 
Machine Vision}, by Dr. Amita Nandal, who is a contributor to 
the currently proposed project.  The Elsevier Covid-19 volume will be 

...
Flow Cytometry, \AIM{}, and \DICOMSR{} data 
...
indeed, if they use \GTagML{}, the will not use 
...
Part I.  The Host Library would serve as a 
...
host, leveraging the fact that the Host Library provides 
...
features to be systematically modeled, in parallel 
to analogous models applicable to other image-related 
annotation domains.  Analogous comments apply 
...
canonical protocol.  This \HCI{} focus 

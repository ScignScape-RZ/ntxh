...
When this functional equivalents 
...
This may be called \q{incidental alignment.}  
There are, in turn, two pathways toward 
incidental alignment.  On the one hand, 
...
\AXFI{} openly embraces \textit{deliberate} 
rather than \textit{incidental} alignment.  
...
or binary stream carryin \AXFI{} data 
...
amount of biolerplate needed for the 
...
modeled as part of the \GTabML{} expression.  

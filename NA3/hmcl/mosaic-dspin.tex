...
software such as \CaPTk{} (the Cancer Imaging and Phenomics Toolkit), so that readers could actually run the author's code as a \CaPTk{} 
...
Language based extension mechanism; cf. \bhref{https://cbica.github.io/CaPTk/tr_integration.html}.}  This kind of
functional assessment and adoption of novel contributions is harder to carry
out if a body of research work is only described indirectly within article
...
interactively reading author's papers.  In particular, these \PDF{}
...
\Pandore{} (an image-processing environment 

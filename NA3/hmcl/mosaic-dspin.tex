...
\ifnum\value{page}=5   %\pgfmathresult>0\relax
\put(182,142){
...
\section{\protect\lMOSAIC Plugins}
\p{By design, \lMOSAIC{} Portals will provide a
suite of plugins
...
software is that it allows the student's work to be evaluated within
the computing environments which scientists actually use to conduct
professional research.  This is different than existing
science-publication portals, which generally rely on web browsers to
access supplemental materials like data sets and multimedia files ---
and, as a result, the software ecosystem wherein readers examine
...
in rigorously reusable and replicable ways.}
...
\section{\protect\lMOSAIC Structured Reporting}
...
\section{\protect\lMOSAIC{} Annotations}
...
\section{\protect\MOSAIC in the context of Image Analysis}

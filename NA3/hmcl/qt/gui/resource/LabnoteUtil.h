...
public:
 ...
 static boolean equalsNull(Object value, Object value2);
  ...
  */
 static <E,F> boolean deepMapEquals(Map<E, F> map, Map<E, F> map2);

 static boolean equalApprox(float x1, float x12);

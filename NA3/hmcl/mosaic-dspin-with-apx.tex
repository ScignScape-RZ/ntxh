...
{\setlength{\fboxsep}{32pt}
	\relscale{1.2}{{\fontfamily{qcr}\fontseries{b}\selectfont%
{The \llMOSAIC{} Publication Repository:\\\textit{Supplemental Archives/ 
Structured Research Reporting/Plugins}}
}}}
\end{center}
\end{minipage}
\end{tcolorbox}
...
\p{In some contexts, however, authors are giving the option to 

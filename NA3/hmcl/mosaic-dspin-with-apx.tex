...
two-dimensional locations are important, depending on whether 
...
given user-interaction event.  In other contexts related 
to \FCM{}, such as \PDF{} rendering and image analysis, there 
...
formats.  A further complication is that some coordinate 
systems use integer values, and others using floating-point numbers.  
It is therefore a resonable practice to factor 

...
{NCN/A3R Native Application Framework 
 (Native-CloudNative/Application as a Resource)}}}}
\end{center}
\end{minipage}
\end{tcolorbox}
\end{center}
...
{\sectsp}
\p{\NCN{}/\A3R{} (hereafter \NAThree{}) is a \Qt{}-based 
...
The \A3R{} (Application-as-a-Resource) model promotes 

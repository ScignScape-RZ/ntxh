...
\section{E-Commerce Slide 5}
\doubleFrameXspec{-7pt}{\textwidth}{These slides demonstrate 
visual cues aiding photo navigation, 
such as color bands (overlays) that switch from horizontal 
to vertical indicating which photos have been viewed so far; and the 
thumbnail of the current viewed photo 
marked with a thick colored border (surrounding the thumbnail 
photo and its overlays).}

...
{\bf \begin{itemize}
\sqitem  {\lsep} Export data and instructions between Qt-based applications (slides 15-16).\vspace{1em}
\sqitem  {\lsep} \parbox[t]{15cm}{Embed document or multi-media viewers inside scientific or 
dataset applications (slides 27-30).}\\\vspace{1.5em}
...
Real Estate, VR, etc. (slides 20-26).}\vspace{1em}

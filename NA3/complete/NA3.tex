...
\newcommand{\lun}[1]{\parbox{6in}{{{\fontfamily{qcr}\selectfont{%
...
\LaTeX{}), the \LaTeX{} labels engineered to enable 
\q{Context Menu Coordination} may be eliminated or 
renamed, which can force a time-consuming task of 
reconstructing text anchors.}

\vspace{2em}
\hspace{-74pt}\noindent\lun{Native Application Development in the Larger \lsIT{} Context \\}

\p{While users have gravitated to web and phone appliations for some 
day-to-day tasks (social networking, banking, e-commerce), desktop-style 
native software remains the preeminent front-end paradign in 
...
developer tools, \Qt{} Creator plugins, and other enhancecments 

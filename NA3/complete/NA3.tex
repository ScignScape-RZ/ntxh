...
{\lunvs}
\noindent\lun{\lsNCN{} and \lsAThreeR{} in Consort}
...
OpenCOG platform) or to HypergraphDB (Hypergraphs 
...
libraries or databases (channels aggregate edges --- most 
...
(\href{https://www.elsevier.com/books/advances-in-ubiquitous-computing/neustein/978-0-12-816801-1}).  Channels are particularly useful when modeling procedure 
...
of floating-point decimals.  (Universal Numbers are a mathematical representation developed 
...
\item A novel channel/hypegraph-based \Cpp{} reflection mechanism, which can be 
...
In general, \HTXN{} is engineered to priotize integrating 
...
\item[Mix-and-Match Formats] Given documents encoded in \HTXN{}, 
\q{secondary documents}, or \q{views}, can be generated in a 
variety of conventional formats, such as \LaTeX{} and \XML{}. 
...
desirable to employ different formats for a single 
...
which outputs \HTXN{} and (from the \HTXN{} files) 
\LaTeX{} or \XML{}.  The \NGML{} parsers can be readily 
...
application that are equipped to call procedures in \Qt{}/\Cpp{} 
libraries (obviously this includes scientific software 
which uses \Qt{} internally).  Many scientific and technical 
applications have a built-in plugin or 
extension mechanism, which makes it possible to introduce \HTXN{} 
as an added features; others are open-source projects where 
...
\noindent\lun{Using \lsHTXN{} and \lsHGDM{} In Consort}
\p{As hypergraph text and data encoding protocols, respectively, 
\HTXN{} and \HGDM{} can interoperate conveniently.  The 
...
publications.  \AThreeR{} components would then be 
...
\noindent\Large{\underline{Case Study}}

...
of generic types, like integers and strings.  

\item A novel channel/hypegraph-based \Cpp{} reflection mechanism, which can be 
used in addition to or in place of \Qt{} meta-objects.

\end{itemize}

\Cpp{} reflection is conducive to Requirements Engineering because 

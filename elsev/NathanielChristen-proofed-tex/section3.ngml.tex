...
hypothetical {\sgapped}\USH{}{\egapped}
{\sadded}Cyber-Physical{\eadded} examples, such as 
...
symbols affected by that kind of abstraction.
{\sgapped}In the notation I adopt here,
...
their interrelationships {\sgapped}describe{\sgapped}
{\sadded}outline{\sadded} a \i{Channel Algebra}, 
...
if valid signatures {\sadded}characterized{\eadded}
{\sgapped}described{\egapped} using channel kinds in

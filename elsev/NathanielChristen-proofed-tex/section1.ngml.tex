...
about the {\sgapped}unique{\egapped} {\sgapped}characteristic{\egapped} 
...
{\check}that is, to languages' compilers and runtimes
).  This means that Requirements Specifications 

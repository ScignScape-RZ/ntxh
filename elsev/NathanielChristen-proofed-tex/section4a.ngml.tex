...
for each \int{} or each two-number range \rRan{} \mdash{} similar to \q{inductive families} as
discussed by Edwin Brady in the context of the Idris language
\cite[page 12]{EdwinBradyImpl}) \mdash{} could easily conflict with 
...
(see e.g. \cite[page 4]{BernardyEtAl}) \mdash{} at least as \i{actual} types.

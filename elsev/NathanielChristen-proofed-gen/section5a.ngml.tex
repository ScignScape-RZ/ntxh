...
to {\sgapped}\bindFn{}{\egapped}{\sadded}\bind{}{\eadded}, 
which in turn (by design) both extracts its
...
{\sgapped}can{\egapped}{\sadded}would{\eadded} be
saved according to its channel-package data structure,

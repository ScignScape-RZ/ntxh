...
{\sadded}not {\sadded}just {\sgapped}as{\egapped} an operational prerequisite for scientific 
...
even if {\sgapped}they{\egapped} {\sadded}these{\eadded}
are technically challenging to model computationally.    
}
...
losing {\sgapped}models'{\egapped}
{\sadded}their{\eadded} underlying formal rigor and tractability.  
...
validating {\sgapped}of{\egapped} coding assumptions) priotize safety at runtime.  

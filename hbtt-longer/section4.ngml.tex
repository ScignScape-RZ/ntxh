...
\p{This distinction notwithstanding, 
...
\p{When discussing procedures' coding assumptions 
(those more fine-grained than type constraints alone can model),  
we need a rigorous definition of the concept \i{procedure} itself, 
...
contexts code-graphs would instead be, at most, convenient expository 
...
identical to the code in source files.

...
itself seen as its own \TVOneToVTwo{} type \mdash{} so 
...
commenting on \i{type constructors}, which derived specialized 
...
presence of numbers that specify \rRan{} at runtime.
The co-constructor for a range type \TrRan{} is accordingly the
\q{common functionality} base function \i{plus} numbers 
...
Conversely, forcing value co-constructors to be

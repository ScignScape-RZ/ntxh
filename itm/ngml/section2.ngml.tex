...
\mdash{} is inspired by Vakarelov's
...
\p{Conceptual Space Theory, on the other hand,
originates with Peter G\"ardenfors's books
and articles \mdash{} especially 2000's \i{Conceptual
Spaces: The Geometry of Thought} \mdash{} but has branched
...
in conceptual structures \mdash{} including identifying
...
\p{To the extent that perceptual and spatial features can be
...
\p{As I see it, the challenge for Conceptual Space Theory is
how to generalize outside the intuitively trenchant but
rather narrow examples of conceptual \q{quantification}, like
color and shape, to model the full range of details \mdash{}
including functional and conceptual roles as well
as perceptual form \mdash{} which influence conceptualization.
After all, while there \i{are} spatial differences between
a \i{tablecloth}, \i{placemat}, and \i{ribbon}
\mdash{} or between a \i{knife}, \i{sword}, and \i{cleaver}
\mdash{} these represent different \i{concepts} because the
...
\p{Research in the overall context of Conceptual Space Theory
...
\p{One option is to consider conceptual \q{space}
...
\p{Another idea is to consider the kind of (canonically perceptual)
...
\mdash{} and/or enactive engagement with the object \mdash{} that
...
\p{This latter model actually integrates well with Vakarelov's ITM:
...
that stays close to G\"ardenfors's original geometric metaphor.
...
\p{Given this possibility, I believe that the systematizing
...
\p{So in this section I will generally approach
efforts to \i{operationalize} Conceptual Spaces
\mdash{} and look back to Vakarelov's paradigm as well
\mdash{} with a mixture of critique and endoresement.
In general I think that these thories are
useful models \mdash{} or at least useful starting-points
\mdash{} for understanding components within cognitive systems
...
through the lens of its own structures \mdash{} how
it effects translations and routing between the
structures of other systems which the
interface interconnects \mdash{} but this \q{local}
analysis does not address how local structures
fit into the \q{semantics} of the whole.
}
\p{The \q{semantics of the whole} is often where science gives
way to Philosophy of Science \mdash{} or even to
...
grounds for the biological \mdash{} chemical
...
\mdash{} e.g., describing someone as \i{drunk}
or \i{posioned} \mdash{} to orient the biological
...
\p{To the degree, then, that we can (\q{metascientifically})
...
\mdash{} of biology supervening on chemistry,
...
\p{I believe this biology/chemistry case is a good metaphor
...
analogous to chemistry and biology \mdash{}
...
as I will mention below \mdash{} so these thories
...
\p{Ultimately, I believe this holistic picture needs to be
...
merit of scientific \mdash{} even computational \mdash{}
...
\p{Towards the end of Section 1 I noted the contrast between how the
...
are not the only communicative species \mdash{} actually,
we are not the only \i{linguistic} species;
it seems counter-productive not call bird sounds or cetacean
and primate vocalizations as a kind of language \mdash{} there
...
\p{Taking Langacker's Cognitive Grammar as canonical,
...
(said of a stall in a Chinatown food court).
\end{sentenceList}
...
\cite[p. 5]{MartinRaubal}.  For sure, our readiness to
...
says something about \q{this facade} \mdash{}
...
the cutting process} \cite[p. 155]{KennethHolmqvist}.
...
\shortdecoline{}
\p{There is, notwithstaning my suggestions to this point, a version of

...
fit together \mdash{} in \i{rescued dogs were fed}, for instance,
...
\p{While Link and Dependency Grammars are both contrasted
...
in turn adds nuance or detail \mdash{} say, in \i{rescued dogs}
...
\p{Continuing analysis of \i{that} qua subordinator:
...
\begin{sentenceList}\sentenceItem{} \label{itm:trumpcolluded} The Trump campaign colluded with Russia.
...
\begin{sentenceList}\sentenceItem{} Obama wouldn't budge on reproductive rights.
\end{sentenceList}
we get a \q{sentient}
...
\p{For each \i{syntactic} bi-dependency, on this theory,
...
presuppositions were flawed \mdash{} the referent of \q{the dogs} has
...
\mdash{} are themselves open-ended and ungrounded or
incompletely grounded.
}
\p{We can speak metaphorically
...
\p{So in the current running example, \i{the} in itself
...
generalization and specificty is an essential feature
